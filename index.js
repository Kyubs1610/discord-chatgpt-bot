...
client.on('messageCreate', async (message) => {
  try {
    ...
    if (message.content.length > msgLengthLimit) {
      message.reply("Tu m'en demandes trop mon pote, je ne peux pas répondre à un message aussi long. Fais moi un petit résumé.");
      return;
    }
    ...
    let conversationLog = [{ role: 'system', content: 'You are a friendly chatbot in Discord.' }];
